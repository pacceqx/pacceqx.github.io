...
<script>
    ...
    var pg20 = formulario.pg20.value;
		...
		soma =  parseInt (pg1) 
          ...
          + parseInt (pg20); 
      if(+soma => 20 && +soma <= 40){
        	alert ("Sua PROATIVIDADE é um pouco baixa e, possivelmente, isso esteja se refletindo em alguns aspectos do seu cotidiano. Tomar consciência desta necessidade é o primeiro passo; o segundo é desenvolver um plano de ação. Converse um pouco mais consigo mesmo, e esteja aberto a receber mais feedback das pessoas.Seja mais observador do comportamento dos outros, especialmente daqueles que você considera muito bons nesta competência. Se precisar de ajuda, conta com a gente, pacceiro!" + soma);
      }else if(+soma > 40 && +soma <= 60){
          alert ("Sua PROATIVIDADE é mediana. Você precisa desenvolvê-la um pouco mais, procurando melhorar naqueles aspectos em que sente mais dificuldade. Converse um pouco mais consigo mesmo, e esteja aberto a receber mais feedback das pessoas. Se precisar de ajuda, conta com a gente, pacceiro!" + soma);
      }
      else if(+soma > 60 && +soma <= 80){
          alert ("Sua PROATIVIDADE é desenvolvida , mas você precisa estimular este comportamento nas pessoas, através de exemplos pessoais e da criação de um ambiente de abertura e confiança para sua equipe. Se precisar de ajuda, conta com a gente, pacceiro!" + soma);
      }
      else if(+soma > 80){
          alert ("Sua PROATIVIDADE é bastante alta. Você é uma pessoa PROATIVA e estimula este comportamento nos outros, através de seu exemplo pessoal e criando um ambiente favorável à iniciativa de sua equipe. Parabéns, pacceiro!" + soma);
      } else{
...
<form id="formulario">
<fieldset><br>
<label for="pergunta">1 - Você percebeu que ainda não teve nenhuma interação marcada pra essa semana. O que você faz?</label><br>
...
<label for="pergunta">2 - Você vê um erro de digitação na arte que foi postada no instagram recentemente. O que faz?</label><br>
...
<label for="pergunta">3 -Vocês estão assistindo um filme online em uma interação e a internet da pessoa que está transmitindo está ruim e travando muito. O que você faz?</label><br>
...
<label for="pergunta">4 - O pacce vai transmitir uma live, sobre um assunto “x”. O que você faz?</label><br>
...
<label for="pergunta">5 - A atividade da formação foi muito complicada de ser feita. O que você faz?</label><br>
...
<label for="pergunta">6 - Você está na reunião semanal e percebe que o microfone da Kassiane não está funcionando bem. O que você faz?</label><br>
...
<label for="pergunta">7 - Vou organizar um evento. O que eu faço?</label><br>
...
<label for="pergunta">8 - Recebo mensagem dizendo ser hora da Reunião Individual. O que faço?</label><br>
...
<label for="pergunta">9 - Você vê que não vai conseguir cumprir as horas semanais</label><br>
...
<label for="pergunta">10 - Você vai fazer um evento na célula. O que você faz?</label><br>
...
<label for="pergunta">11 - Kassiane avisa que as frequências da célula precisam ser entregues no final do mês. O que você faz?</label><br>
...
<label for="pergunta">12 - Esqueceu / perdeu a noção do tempo para fazer Planejamento e Feedback. O que você faz?</label><br>
...
<label for="pergunta">13 - Surgiu um desentendimento entre você e outro bolsista e você se sentiu ofendido. O que faz?</label><br>
...
<label for="pergunta">14 - Alguém aparece pedindo informação sobre as coisas do PACCE. Como você age?</label><br>
...
<label for="pergunta">15 - Vi que um bolsista está passando por um sério problema familiar. O que faço?</label><br>
...
<label for="pergunta">16 - Estava nas redes sociais e vi um post falando mal do PACCE. Como devo agir?</label><br>
...
<label for="pergunta">17 - Estou em equipe da formação com pessoas que não colaboram. O que eu faço?</label><br>
...
<label for="pergunta">18 - Você sabe que em uma semana não estará disponível para as atividades. O que você faz?</label><br>
...
<label for="pergunta">19 - Você viu no site que está faltando uma notícia de um evento que já aconteceu. O que você faz?</label><br>
...
<label for="pergunta">20 - Alguém vai no grupo e pergunta quem está livre para um teste de live. Se você estiver livre, o que você faz?</label><br>
